...
try:
    ...
    from joints_detectors.Alphapose.yolo.util import predict_transform
        ...
        # If it is a route layer
            ...
            if len(x["layers"]) <= 2:
                ...
                filters = (
                    ...
                    + output_filters[index + int(x["layers"][1])]
                    + output_filters[index + int(x["layers"][2])]
                    + output_filters[index + int(x["layers"][3])]
                )
